  ...
  const queryInsightsSnapshotSpans: DemoSpanSeed[] = [
    ...
    },
    {
      attributes: {
        ...
        "http.response.status_code": 200,
        "network.protocol.name": "http",
        "server.address": "accelerate.prisma-data.net",
        "url.full": "https://accelerate.prisma-data.net/query",
        "url.path": "/query",
        "url.scheme": "https",
        "user_agent.original":
          "Cloudflare-Workers PrismaEngine/3c6e192761c0362d496ed980de936e2f3cebc3da PrismaClient/7.8.0",
      },
      durationMs: 431,
      kind: "client",
      name: "fetch POST accelerate.prisma-data.net",
      parentIndex: 2,
      resourceAttributes: consoleWorkerResource,
      service: "console",
      startOffsetMs: 431,
    ...
    },
    {
      ...
      durationMs: 625,
      kind: "client",
      name: "fetch GET accelerate.prisma-data.net",
      parentIndex: 0,
      resourceAttributes: consoleWorkerResource,
      service: "console",
      startOffsetMs: 0,
